  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="mt-1 max-w-sm text-sm text-muted-foreground">
        There are no new products added in the last 30 days. Check back soon for
        fresh drops!
      </p>
    </div>
  );
...
export default function NewArrivalsPage() {
  const products = useQuery(api.storefront.newArrivals.getNewArrivals);
    ...
    <div className="mx-auto max-w-7xl px-4 pb-10 pt-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Fresh drops from the last 30 days
        </p>
      </div>
